...
const images = [
  '/images/pages/dobbs-1.png',
  '/images/pages/dobbs-2.png',
  '/images/pages/dobbs-3.png',
  '/images/pages/dobbs-4.png',
]

export default function DobbsFerry() {
